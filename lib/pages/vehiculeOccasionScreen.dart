...
class VehiculeOccasionScreen extends StatelessWidget with NavigationStates  {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        title: Text('Véhicule Occasion',style: TextStyle(fontSize : 20, fontWeight: FontWeight.w500), ),
